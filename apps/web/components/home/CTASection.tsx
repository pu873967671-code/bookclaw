...
export function CTASection() {
  return (
    <section id="cta" className="text-center px-12 pb-32 pt-20 max-w-[1280px] mx-auto">
      <p className="text-[11px] font-medium tracking-[0.1em] uppercase text-ink-30 mb-4">
        Open source · MIT
      </p>
      ...
      <div className="flex gap-4 justify-center items-center flex-wrap">
        <Link
          ...
          className="
            ...
            text-[15px] font-medium px-7 py-3.5
        ...
        <Link
          href="https://github.com/pu873967671-code/bookclaw/blob/main/DEPLOY.md"
      ...
      <p className="mt-5 text-xs text-ink-30 flex items-center gap-1.5 justify-center">
